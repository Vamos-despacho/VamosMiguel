...
const Trayectoria = () => {
    return (
        <div className="mx-auto w-full  sm:py-20 py-6 max-w-7xl lg:px-8 ">
                ...
                <div className="mx-auto max-w-2xl lg:max-w-5xl">
                    ...
                    lg:gap-y-12" >
                        ...
                        <div className='lg:pl-20'>
                            <ul role='list'>
                                <li className="flex">
                                    <Link className="group flex text-sm font-medium text-zinc-800
                                ...
                                <li className="mt-4 flex">
                                    <Link className="group flex text-sm font-medium text-zinc-800 
                                transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://www.instagram.com/miguelangelcamposlima">
                                        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 flex-none fill-zinc-800 transition group-hover:fill-teal-500">
                                ...
                                <li className="mt-8 border-t border-gray-300 pt-8 dark:border-zinc-700/40 flex">
                                    <Link className="group flex  items-center text-sm font-medium text-zinc-800 
