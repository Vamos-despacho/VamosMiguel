...
export const propuestas: IPropuestas[] = [
  {
    ...
    propuestas: [
      ...
      },
      {
        ...
        estado: LawProposalState.AprobadoEnPrimerDebate,
        ver: true,
      },
      {
        id: 3,
  ...
  },
  {
    ...
    propuestas: [
      ...
      },
      {
        id: 5,
        titulo:
          "Inclusión de la Inteligencia Artificial en el Sistema Educativo",
    ...
    propuestas: [
      {
        ...
        text: "Implementación de la inteligencia artificial (IA) en el sistema educativo para mejorar la gestión de la educación, empoderar a gestores, docentes y estudiantes, mejorar el aprendizaje y la evaluación, y garantizar que la IA se utilice para empoderar a los docentes y proteger sus derechos.",
        text2:
          "Objetivos: Promover el reciclaje, cultura de segregación, economía circular, correcta disposición de la basura, mejorar recolección, mantener limpios parques y plazas, reducir contaminación ambiental, crear ambientes sanos, preservar medio ambiente, y ahorrar energía al reciclar.",
        link: "/Propuesta1",
        estado: LawProposalState.NoIniciado,
        ver: false,
      },
    ...
    propuestas: [
      {
        ...
        text2:
          "Restricciones: Ninguna persona inscrita en algún partido político podrá aspirar a trabajar en el estado.",
        text3:
          "Prohibición de recomendaciones para puestos de trabajo por parte de figuras políticas como diputados, representantes, alcaldes, ministros, presidentes o vicepresidentes.",
        link: "/Propuesta1",
        estado: LawProposalState.NoIniciado,
        ver: false,
      },
  ...
  },
  {
    ...
    propuestas: [
      ...
      },
      {
        ...
        text2:
          "Imponer penas de prisión a los servidores públicos que realicen dichos nombramientos.",
        link: "/Propuesta1",
        estado: LawProposalState.NoIniciado,
        ver: false,
      },
      {
        ...
        text2:
          "Supervisar que los bienes adquiridos estén acordes al salario obtenido al final de su gestión.",
        link: "/Propuesta1",
        estado: LawProposalState.NoIniciado,
        ver: false,
      },
    ...
    propuestas: [
      {
        ...
        text2:
          "Acceso rápido y gratuito a atención médica en centros básicos de atención primaria.",
        text3:
          "Dotación de capital humano, nombramiento de médicos de tiempo completo, personal técnico idóneo y de especialidades.",
        text4:
          "Correcto abastecimiento de insumos médicos, revisión de políticas de compra, importación y comercialización de fármacos.",
        text5:
          "Mejora continua de la digitalización de la administración de salud pública, con información disponible a los usuarios.",
        text6:
          "Creación de un registro de personas con discapacidades, enfermedades raras y crónicas para un balance real de la población y optimizar la atención médica y suministro de medicamentos.",
        link: "/Propuesta1",
        estado: LawProposalState.NoIniciado,
        ver: false,
      },
  ...
  },
  {
    ...
    propuestas: [
      ...
      },
      {
        ...
        text3:
          "Prohibir que el órgano ejecutivo decrete la confidencialidad de las actas de sus reuniones.",
        link: "/Propuesta1",
        estado: LawProposalState.NoIniciado,
        ver: false,
      },
    ...
    propuestas: [
      {
        ...
        text2:
          "Eliminación de viáticos para viajes al exterior y vuelos en primera clase.",
        text3:
          "Devolución de viáticos no utilizados para giras al interior de la república, con detalle del uso si fue utilizado.",
