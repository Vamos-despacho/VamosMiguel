      ...
      <div className=" px-2 sm:px-10 mb-8">
        ...
        <div className="mt-6 ">
          <p className="mb-4 text-xl font-display text-neutral-700 ">
            Accede a las intervenciones en el pleno, que incluyen debates clave,
            propuestas legislativas y la presentación de anteproyectos. Mantente
            informado sobre el trabajo y las contribuciones en el ámbito
            legislativo.{" "}
          </p>
        </div>
      </div>
