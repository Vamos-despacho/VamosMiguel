                ...
                <div className="relative px-4 sm:px-8 lg:px-12">
                    <div className="mx-auto max-w-2xl lg:max-w-5xl">
                        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12" >
                            <div className=''>
                                <div className="max-w-xs px-2.5 lg:max-w-none lg:order-first" >
                            ...
                            <div className=' lg:row-span-2 lg:pl-20'>
                                <h1 className="text-2xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-3xl text-justify">
                                    Conoce a Sara Itzela Gómez Castillo - Nuestra Candidata a Diputado Suplente                                </h1>
                                <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400 text-justify">
                                    <p>Esta destacada figura nació un 14 de septiembre de 1966 y actualmente reside en Canto del Llano. Su trayectoria académica incluye estudios en el Instituto Urraca, donde posteriormente obtuvo su título de Licenciada en Farmacia, con una especialización en Farmacia Clínica y un enfoque especial en Atención Farmacéutica de la Universidad de Panamá.</p>
                            ...
                            <div className='lg:pl-5'>
                                ...
                                transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://twitter.com/miguel3965">
                                            ...
                                            <span className="ml-4">Sigueme en Twitter</span>
                                        </a>
                                    </li> */}
                                    <li className="flex">
                                        <a className="group flex text-sm font-medium text-zinc-800 
                                ...
                                transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://www.facebook.com/miguelangel.camposlima">
                                            <svg viewBox="0 0 24 22" aria-hidden="true" className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500">
                                                <path
                                                    d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />

                                            </svg>
                                            <span className="ml-4">Sigueme en Facebook</span>
                                        </a>
                                    </li> */}
