                ...
                <div className="mx-auto max-w-2xl lg:max-w-5xl">
                    ...
                    lg:gap-y-12" >
                        ...
                        <div className='lg:pl-20'>
                            <ul role='list'>
                                <li className="flex">
                                    <a className="group flex text-sm font-medium text-zinc-50
                                transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://twitter.com/miguel3965">
                                        <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 flex-none fill-zinc-50 transition group-hover:fill-teal-500">
                                ...
                                transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://www.instagram.com/miguel3965">
                                        ...
                                        <span className="ml-4">Sigueme en Instagran</span>
                                    </a>
                                </li>
                                <li className="mt-4 flex">
                                    <a className="group flex text-sm font-medium text-zinc-50 
                                transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="https://www.facebook.com/miguelangel.camposlima">
                                        <svg viewBox="0 0 24 22" aria-hidden="true" className="h-6 w-6 flex-none fill-zinc-50 transition group-hover:fill-teal-500">
                                            <path
                                ...
                                <li className="mt-8 border-t border-amarillov pt-8 dark:border-zinc-700/40 flex">
                                    <a className="group flex text-sm font-medium text-zinc-50 
                                    transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"
                                        ...
                                        <span className="ml-4">miguel@gmail.com</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
