...
const teamMembers: TeamMember[] = [
  {
    name: "Antonio Sanmartin",
    role: "JEFE DE DESPACHO",
    salary: "$3,500",
    imgSrc: "/equipo/Antonio3.webp",
  },
  {
      ...
      <div className="container mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 lg:py-16">
        <div className="lg:grid lg:grid-cols-3 lg:gap-8">
          <div className="lg:col-span-1 ">
            <h2
              className="block  font-display tracking-tight [text-wrap:balance] text-4xl font-semibold sm:text-4
                        xl text-azulv"
            >
              Equipo de Trabajo
            </h2>
            <p className="mt-2 text-lg font-display text-neutral-500">
              Despacho 209
            </p>
          </div>
