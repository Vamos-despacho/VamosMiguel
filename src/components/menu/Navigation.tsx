...
const Navigation = () => {
    ...
    return (
        <Menubar className='border-none'>
            ...
            <MenubarMenu>
                <MenubarTrigger
                    className='hover:bg-gray-100 flex items-center text-base lg:text-lg text-azulv' >
                    Despacho
            ...
            <MenubarMenu>
                <MenubarTrigger
                    className='hover:bg-gray-100 flex text-base lg:text-lg text-azulv justify-center items-center' >
                    Labor Legislativa
