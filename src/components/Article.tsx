          ...
          hover:bg-neutral-50  max-w-sm  h-[300px] sm:h-[465px]' >
            ...
            <div className='flex  sm:space-x-4 items-center space-x-1 m-auto'>
                ...
                <div className='sm:space-y-1'>
                    <p className='  font-semibold text-[12px] sm:text-sm'>Miguel Ángel Campos</p>
                    <div className='flex flex-col sm:flex-row sm:space-x-2  text-neutral-950 '>
                        <p className=' font-medium text-[12px] sm:text-sm'>{article.category.name}</p>
                        <p className='text-neutral-400 text-[8px] sm:text-sm'>{formattedDate}</p>
                    </div>
                </div>
            </div>
            <div className='sm:h-[118px]  sm:mt-3 mt-2    '>
                <div className='    '>
                    <p className=' font-medium  text-sm sm:text-base sm:font-semibold text-neutral-800 sm:leading-5 leading-3'>
                        {article.title}
                    </p>
                </div>
                <div className=' flex sm:mt-2 mt-1'>
                    {
                        article.content && <div
                            className=' text-[12px] mx-1 sm:text-sm text-neutral-600 sm:line-clamp-4 line-clamp-4 sm:leading-4 leading-3 font-display'
